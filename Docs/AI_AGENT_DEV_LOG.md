...
- Shop/equipment still opens a placeholder page; counter, notice board, and party table now have real Web transition videos, with party table using a looping video backdrop after entry.
