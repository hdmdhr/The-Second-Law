...
namespace SecondLaw
{
    ...
    public static class LocalizationService
    {
        ...
        private static readonly Dictionary<string, string> Zh = new Dictionary<string, string>
        {
            ...
            { "guild.placeholder.board.body", "这里之后会显示可接委托、推荐等级、奖励和任务类型。第一版先保留热区入口。" },
            { "guild.placeholder.table.title", "伙伴募集" },
            { "guild.placeholder.table.body", "这里之后会显示伙伴列表、联机邀请和组队入口。第一版先保留热区入口。" },
            { "guild.placeholder.shop.title", "装备与药剂" },
            { "guild.placeholder.shop.body", "这里之后会显示商店、药剂、武器防具和玩家装备管理。第一版先保留热区入口。" },
            { "quest.target", "目标" },
            { "quest.slimes", "史莱姆" },
            { "quest.reward", "报酬" },
            { "button.accept", "接受委托" },
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string>
        {
            ...
            { "guild.placeholder.board.body", "This page will show available requests, recommended levels, rewards, and request types. The first pass keeps the hotspot entry in place." },
            { "guild.placeholder.table.title", "Party Finder" },
            { "guild.placeholder.table.body", "This page will show party members, co-op invites, and matchmaking entry points. The first pass keeps the hotspot entry in place." },
            { "guild.placeholder.shop.title", "Gear & Potions" },
            { "guild.placeholder.shop.body", "This page will show shops, potions, weapons, armor, and player equipment management. The first pass keeps the hotspot entry in place." },
            { "quest.target", "Target" },
            { "quest.slimes", "slimes" },
            { "quest.reward", "Reward" },
